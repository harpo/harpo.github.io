...
const init_phones = ["Bad Guy 2022","IEF Comp"],             // Optional. Which graphs to display on initial load. Note: Share URLs will override this set
      ...
      watermark_text = "HarpoGraph",                 // Optional. Watermark appears behind graphs
      watermark_image_url = "HG.svg",   			// Optional. If image file is in same directory as config, can be just the filename
...
const targets = [
    { type:"Preference", files:["Harpo", "Harpo v4", "Morty Bass","Rickdiculous Bass","AX", "EJ"] },
    { type:"Reviewer",   files:["Bad Guy 2022", "RikudouGoku","Super Review","Banbeucmas","Crinacle","Precogvision"] },
...
let headerLogoText = "Harpo",
    headerLogoImgUrl = "",
    headerLinks = [
    {
        name: "YouTube",
        url: "https://www.youtube.com/@harpokrates"
    }
];
